...
**🎯 Foco Atual | Current Focus:** Cloud & MLOps | AWS • GCP • Azure • IBM Cognos
...
### 🏦 Analista de Cibersegurança | **Sicredi**
**📅 Jan 2023 - Jun 2025 (2 anos 6 meses)**

Atuação estratégica na prevenção, detecção e resposta a fraudes e riscos cibernéticos, utilizando análise de dados e IA para fortalecer a segurança corporativa. Desenvolvimento de projetos enterprise-grade com foco em segurança e inteligência artificial.

**Competências:** Mineração de dados, Engenharia de dados, Análise de segurança, Machine Learning aplicado à detecção de fraudes

---

### 💻 Cientista e Analista de Dados | **Autônomo**
**📅 Mar 2021 - Presente (4 anos 8 meses)**

Desenvolvimento de mais de **350 repositórios no GitHub** focados em IA, Ciência de Dados, Big Data e Bioinformática. Ampla experiência em MLOps, NLP e arquiteturas de dados. Projetos abrangendo finanças, saúde, biotecnologia e sistemas corporativos.

**Competências:** Mineração de dados, Analítica de dados, Machine Learning, Deep Learning, MLOps, NLP, Computer Vision

---

### 🌐 Estagiário Full-Stack | **EBANX**
**📅 Mar 2022 - Jan 2023 (11 meses)**

Contribuição no desenvolvimento e manutenção de aplicações web escaláveis e seguras em um ambiente de fintech de alto crescimento. Experiência prática com tecnologias modernas de desenvolvimento web.

**Competências:** HTML5, CSS3, JavaScript, TypeScript, React, Node.js, APIs RESTful, Desenvolvimento Ágil

---

### 🛒 Gestor de E-commerce | **Mercado Livre**
**📅 Fev 2020 - Jan 2022 (2 anos)**

Gestão completa de operações de e-commerce, desde o planejamento estratégico até o pós-venda. Condução de todas as etapas do processo de vendas na plataforma.

**Competências:** Vendas diretas, Gestão de vendas, E-commerce, Atendimento ao cliente
...
- **Business Analytics Specialization**
  ...
  - Competências: ETL, Análise de negócios, Business Intelligence
...
[![Veja todas as credenciais](https://img.shields.io/badge/Credly-Ver_Todas_as_Certificações-FF6B00?style=for-the-badge&logo=credly&logoColor=white)](https://www.credly.com/users/gabriel-demetrios-lafis/badges)
...
## 🎯 Interesses Profissionais | Professional Interests

- 📊 **Advanced Analytics:** Desenvolvimento de modelos sofisticados para problemas complexos de negócio
- 🤖 **AI Innovation:** Exploração de tecnologias de IA de ponta e suas aplicações
- 🛡️ **Cybersecurity:** Implementação de soluções de segurança orientadas por IA
...
**🌐 Conexões no LinkedIn:** +500 | **👥 Seguidores:** 3.455
